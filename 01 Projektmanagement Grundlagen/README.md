...
```mermaid
flowchart TD
  A(Bedarf / Problem / Idee) --> B(Analyse)
  B --> C(Projektantrag)
  C --> D(Managemententscheid)
  D --> E(Projektstart)
```
